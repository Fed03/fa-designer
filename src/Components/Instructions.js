            ...
            <div className="row">
              <div className="col">
                ...
                <p>
                  ...
                  !<br />
                  <span className="key-indicator">dblClick</span> anywhere on
                  the canvas to create a State.
                </p>
                ...
                <p>
                  Last but not least, to create reentrant transition - that is
                  an edge starting and ending to the same state - just{" "}
              ...
              <div className="col">
                ...
                <p>
                  ...
                  <span className="key-indicator">Alt</span> key and dragging
                  the canvas will create a multi-selection box. States selected
                  together are grouped; this means that moving one state will
                  move the others accordingly.
                </p>
              ...
              <div className="col">
                ...
                <p>
                  ...
                  <br />
                  If, instead, you want to mark or unmark a state as final you
                  can <span className="key-indicator">Alt+click</span> on it.
                </p>
              </div>
            </div>
          </div>
